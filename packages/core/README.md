...
- `@theia/core/electron-shared/...`
  ...
  - `electron-store` (from [`electron-store@^10.0.1`](https://www.npmjs.com/package/electron-store))
  - `electron` (from [`electron@36.2.1`](https://www.npmjs.com/package/electron/v/36.2.1))
- `@theia/core/shared/...`
